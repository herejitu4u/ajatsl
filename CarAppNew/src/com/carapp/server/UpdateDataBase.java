...
public class UpdateDataBase extends AsyncTask<String, Integer, String>{
	 ...
	 private String action;
	  ...
	  public UpdateDataBase(Context context,String action)
	  {
	...
	protected String doInBackground(String... params) {
		...
		paramList.add(new BasicNameValuePair("tyre_condition_lf",UploadDataInfo.tyer_condition_lf));
		paramList.add(new BasicNameValuePair("tyre_condition_lb",UploadDataInfo.tyer_condition_lb));
		paramList.add(new BasicNameValuePair("tyre_condition_rf",UploadDataInfo.tyer_condition_rf));
		paramList.add(new BasicNameValuePair("tyre_condition_rb",UploadDataInfo.tyer_condition_rb));
	...
	//***********************************************************************	
		...
		paramList.add(new BasicNameValuePair("cust_visit_reason",str1));
		}
		...
		paramList.add(new BasicNameValuePair("dealer_recommendations",str2));
		}
		//***********************************************************************	
		...
		//*****************new*****************
			...
			/*	paramList.add(new BasicNameValuePair("FF",UploadDataInfo.FF));
				...
				*/
				paramList.add(new BasicNameValuePair("quotation1",UploadDataInfo.Quotation1));
				paramList.add(new BasicNameValuePair("quotation2",UploadDataInfo.Quotation2));
